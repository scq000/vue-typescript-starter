...
const createVM = function (component, mounted = false) {
  const elm = createElm();

  if (Object.prototype.toString.call(component) === '[object String]') {
    component = { template: component };
  }
  return new Vue(component).$mount(mounted ? elm : null);
};
...
export { destroyVM, createVM, createElm, createVue, createTest, triggerEvent, triggerClick };
